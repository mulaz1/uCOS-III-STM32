...
#define  OS_CFG_ISR_STK_SIZE                             256u//128u
                                                                /* Maximum number of messages                           */
#define  OS_CFG_MSG_POOL_SIZE                             450u//32u
...
#define  OS_CFG_IDLE_TASK_STK_SIZE                        128u//64u


                                                                /* ------------------ STATISTIC TASK ------------------ */
                                                                /* Priority                                             */
#define  OS_CFG_STAT_TASK_PRIO  3u//((OS_PRIO)(OS_CFG_PRIO_MAX-2u))
...
#define  OS_CFG_TMR_TASK_PRIO   2u//((OS_PRIO)(OS_CFG_PRIO_MAX-3u))
                                                                /* Stack size (number of CPU_STK elements)              */
